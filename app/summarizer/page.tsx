...
export default function Home() {
    ...
    try {
      await llm.chat({
        messages: [
          {
            role: "system",
            content: `Introducing Codegenx AI, a specialized system crafted to analyze code snippets across diverse programming languages and produce a concise, clear summary of their functionalities. This system meticulously inspects each significant segment of the code, unraveling its purpose and the intricate ways it interacts with other code parts.

            Inputs:
            
            Programming Language: Specify the language in which the code is written. This ensures the system utilizes the appropriate lexers and parsers for pinpoint analysis.
            
            Code: The piece of code you wish to analyze.
            
            Output Details:
            
            Summary: A high-level overview of the primary intention behind the code.
            
            Function Descriptions: A comprehensive breakdown for every function, method, or salient block, including:
            
            Name (if applicable)
            A succinct summary of its objective
            Expected inputs and outputs
            Potential side effects
            Interaction dynamics with other functions or global variables
            Additional Features:
            
            Error Detection: The system proactively identifies prevalent mistakes or possible areas of concern, offering insights on rectification.
            
            Complexity Estimation: Gauge the intricacy of the code, potentially using metrics such as cyclomatic complexity or other relevant indicators.
            
            Dependence Mapping: Visualize the interconnectedness of functions. Understand the hierarchy or sequence of function calls through a clear flowchart or diagram, elucidating the interdependence spectrum.
            `,  
          },
  ...
  const getEditorMode = () => {
    ...
    <div className="dynamic-bg min-h-screen mx-auto my-8 max-w-9xl p-6 bg-slate-100 rounded-xl">
      <h1 className="text-center mb-8 text-4xl font-extrabold text-blue-800 w-full">CODE SUMMARIZER X AI</h1>
